...
public class PullToRefreshListView extends ListView{
    ...
    private void init(){
        ...
        header = (LinearLayout) headerContainer.findViewById(R.id.ptr_id_header);
        ...
        //第一次更新
        if(0 == lastTimeInMillis)
        {
        	lastUpdatedText = getContext().getString(R.string.str_first_refresh);
        }
        //非第一次更新
        else
        {
        	long intervalInMills = System.currentTimeMillis() - lastTimeInMillis;
        	int minutes = (int)(intervalInMills/1000/60);
        	if(0 >= minutes)
        	{
        		minutes = 1;
        	}
        	
        	lastUpdatedText = getContext().getString(R.string.str_refresh_before);
        	lastUpdatedText.replace("%TIME", "" + minutes);
